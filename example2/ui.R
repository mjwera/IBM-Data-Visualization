...
shinyUI(fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      h3("Explore mtcars"), #header title
      varSelectInput("continuous_variable", "Select Continuous Variable", data = select(mtcars, -categorical_varibles), selected = "mpg"), #order of elements are the inputID, label, data
      varSelectInput("categorical_variable", "Select Categorical Variable", data = mtcars[categorical_varibles], selected = "cyl"),
      ...
      radioButtons("hist_fill", "Histogram fill color", choices = c("default", "blue")),
